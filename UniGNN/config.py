...
def parse():
    ...
    p.add_argument('--data', type=str, required=True, help='data name (coauthorship/cocitation)')
    p.add_argument('--dataset', type=str, required=True, help='dataset name (e.g.: cora/dblp for coauthorship, cora/citeseer/pubmed for cocitation)')
